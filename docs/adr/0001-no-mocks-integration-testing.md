...
compile errors via the owned MET001–MET007 analyzers (see `docs/server/TESTING.md`). We chose
...
- Test doubles exist only for owned seams (e.g. `FakeMessageBus`), reviewed case by case.
