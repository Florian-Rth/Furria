...
2. **RESOLVED 2026-09-23 — Decision W was revised to *yes*, the seeder reconciles on every
   start** (keys, archive flag, Inhaberschaft, and the Account's `is_disabled`). The account below
   is kept as the record of how the question arose. **A new §12 decision is owed on the Admin-Rolle
