...
interface TuschGlassRingProps {
  host: HTMLElement | null;
  ringX: number;
  glow: MotionValue<number>;
}

export const TuschGlassRing: FC<TuschGlassRingProps> = ({ host, ringX, glow }) => {
  if (host === null) {
    return null;
  }
  ...
  return createPortal(
    <Box component="span" aria-hidden data-tusch-ring sx={ringPaint}>
