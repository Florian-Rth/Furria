...
const geometry: DockGeometry = {
  headline: { left: 20, top: 76, width: 350, height: 44, glyph: 40 },
  slot: { left: 49, top: 26, width: 300, height: 24, glyph: 20 },
  headlineText: 'Mitglieder',
  titleWidth: 74,
};
...
describe('dockFlightAt', () => {
  it.each([
    ...
    const placement = dockFlightAt(scrollOffset, geometry, 60);
