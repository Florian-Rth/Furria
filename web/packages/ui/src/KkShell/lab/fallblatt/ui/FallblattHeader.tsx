...
import { useFallblattHeaderFold } from '../logic/use-fallblatt-header-fold';
...
export const FallblattHeader: FC<KkHandoverHeaderProps> = ({ kind, children }) => {
  const fold = useFallblattHeaderFold();
