...
import type { FanfareGeometry, FanfarePlan } from './fanfare-score';
import {
  buzzPatternOf,
  contactOf,
  crossingOf,
...
const quietPlan: FanfarePlan = { ...impactPlan, strike: 'quiet' };
