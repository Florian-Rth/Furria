  ...
  buildEvent(
    {
      ...
      teaser:
        'Der große Auftakt: ein Abend volles Programm mit allen Gruppen des Vereins. Traditionell zuerst ausverkauft.',
  ...
  buildEvent(
    {
      ...
      teaser: 'Dasselbe Programm, zweiter Abend — und meist die letzte Chance auf Karten.',
      ageHint: 'ab 12 Jahren empfohlen',
      priceCents: 1400,
      capacity: 260,
      presaleStartsAt: '2026-11-11T11:11',
  ...
  buildEvent(
    {
      ...
      teaser: 'Der Abend der Frauen: kurzes Programm, lange Tanzfläche.',
  ...
  buildEvent(
    {
      ...
      doorsOpenAt: null,
      teaser: 'Kaffee, Kuchen und Programm bei Tageslicht — ruhiger, gemütlicher, genauso lustig.',
      ageHint: null,
      priceCents: null,
      capacity: null,
