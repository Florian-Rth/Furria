...
interface KompassWhyRowProps {
  reason: MatchReason;
  groupName: string;
}

export const KompassWhyRow: FC<KompassWhyRowProps> = ({ reason, groupName }) => {
  ...
  return (
    ...
    >
      ...
      >
        {kompassAgreementLabels[reason.agreement]}
      </Typography>
